...
INSERT INTO ACCOUNT (ID, USERNAME, STATUS, CREATED) VALUES (DEFAULT, 'artyom', 'APPROVED', CURRENT_TIMESTAMP);
INSERT INTO ACCOUNT_VERSION (ID, ACCOUNT_FK, NAME, LAST_NAME, MAIL, CREATED) VALUES (DEFAULT, 1, 'Artyom', 'Stukans', 'artjoms.stukans@gmail.com', CURRENT_TIMESTAMP);
INSERT INTO CREDENTIAL_VERSION (ID, ACCOUNT_FK, PASSWORD, CREATED) VALUES (DEFAULT, 1, 'f7jL62H91Crd8e4JsWzkI2EehYYxOceX2ZewUlrdYOI=', CURRENT_TIMESTAMP);
...
INSERT INTO ACCOUNT (ID, USERNAME, STATUS, CREATED) VALUES (DEFAULT, 'asja', 'APPROVED', CURRENT_TIMESTAMP);
INSERT INTO ACCOUNT_VERSION (ID, ACCOUNT_FK, NAME, LAST_NAME, MAIL, CREATED) VALUES (DEFAULT, 2, 'Asja', 'Sirova', 'asasirov@gmail.com', CURRENT_TIMESTAMP);
INSERT INTO CREDENTIAL_VERSION (ID, ACCOUNT_FK, PASSWORD, CREATED) VALUES (DEFAULT, 2, 'a//hsN52KaiuPdUsusb0A/SQndbYHpke8cPnDi8vmUQ=', CURRENT_TIMESTAMP);
...
--
INSERT INTO ACCOUNT (ID, USERNAME, STATUS, CREATED) VALUES (DEFAULT, 'julija', 'APPROVED', CURRENT_TIMESTAMP);
INSERT INTO ACCOUNT_VERSION (ID, ACCOUNT_FK, NAME, LAST_NAME, MAIL, CREATED) VALUES (DEFAULT, 3, 'Julija', 'Stukane', 'julja6ka@gmail.com', CURRENT_TIMESTAMP);
INSERT INTO CREDENTIAL_VERSION (ID, ACCOUNT_FK, PASSWORD, CREATED) VALUES (DEFAULT, 3, 'z8xcO/5hKgYniF1m1WjSATRLN7+/fzsxWHrzgbW68yc=', CURRENT_TIMESTAMP);
