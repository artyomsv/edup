CREATE TABLE ACCOUNT_VERSION (
  ACCOUNT_VERSION_ID SERIAL PRIMARY KEY       NOT NULL,
...
CREATE TABLE CREDENTIAL_VERSION (
  CREDENTIAL_VERSION_ID SERIAL PRIMARY KEY       NOT NULL,
  ACCOUNT_FK            BIGINT                   NOT NULL,
...
CREATE TABLE ACCOUNT (
  ...
  ACCOUNT_VERSION_FK    BIGINT REFERENCES ACCOUNT_VERSION (ACCOUNT_VERSION_ID),
  CREDENTIAL_VERSION_FK BIGINT REFERENCES CREDENTIAL_VERSION (CREDENTIAL_VERSION_ID),
...
CREATE TABLE USER_ROLE (
  ...
  ACCOUNT_FK   BIGINT             NOT NULL REFERENCES ACCOUNT (ACCOUNT_ID),
...
CREATE TABLE PASSWORD_RESET (
  ...
  ACCOUNT_FK            BIGINT REFERENCES ACCOUNT (ACCOUNT_ID),
  CREDENTIAL_VERSION_FK BIGINT REFERENCES CREDENTIAL_VERSION (CREDENTIAL_VERSION_ID),
  IP                    VARCHAR(32),
...
INSERT INTO ACCOUNT (ACCOUNT_ID, USERNAME, STATUS, CREATED)
VALUES (DEFAULT, 'admin', 'APPROVED', CURRENT_TIMESTAMP);

INSERT INTO ACCOUNT_VERSION (ACCOUNT_VERSION_ID, ACCOUNT_FK, NAME, LAST_NAME, MAIL, CREATED)
VALUES (DEFAULT, 1, 'Artjoms', 'Stukans', 'artjoms.stukans@gmail.com', CURRENT_TIMESTAMP);

INSERT INTO CREDENTIAL_VERSION (CREDENTIAL_VERSION_ID, ACCOUNT_FK, PASSWORD, CREATED)
VALUES (DEFAULT, 1, 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', CURRENT_TIMESTAMP);

INSERT INTO USER_ROLE (USER_ROLE_ID, ACCOUNT_FK, ROLE, CREATED)
