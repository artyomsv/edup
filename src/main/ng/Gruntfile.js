...
module.exports = function (grunt) {
        ...
        concat: {
            js: {
                src: [
                    ...
                    'app/tabs/reports/reports.module.js',
                    'app/tabs/reports/**/*.js',
            ...
            bundle: {
                src: [
                    ...
                    'vendor/bower_components/angular-file-upload/dist/angular-file-upload.min.js',
                    'vendor/bower_components/angular-utils-pagination/dirPagination.js',
                    'vendor/bower_components/angular-money-directive/dist/angular-money-directive.js',
                    'vendor/bower_components/alertifyjs/dist/js/ngAlertify.js',
    ...
    grunt.registerTask('dist-digital_ocean', ['lint', 'clean', 'ngconstant:digital_ocean', 'dist:js', 'dist:style', 'concat:bundle', 'uglify:bundle', 'copy']);
