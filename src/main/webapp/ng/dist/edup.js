...
angular.module('edup.students')
    ...
    .controller('NewStudentModalController', ['$scope', 'RestService', function ($scope, RestService) {
...
angular.module('edup.widgets')
    ...
    .directive('balanceModal', ['RestService', function (RestService) {
        return {
            restrict: 'E',
