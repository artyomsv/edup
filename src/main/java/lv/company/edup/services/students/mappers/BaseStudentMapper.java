...
public class BaseStudentMapper implements CustomMapper {
    ...
    public void register(MapperFactory factory) {
        factory.classMap(Student.class, LeanStudentDto.class)
                .customize(new ma.glasnost.orika.CustomMapper<Student, LeanStudentDto>() {
                    @Override
                    public void mapAtoB(Student student, LeanStudentDto dto, MappingContext context) {
                    ...
                    @Override
                    public void mapBtoA(LeanStudentDto dto, Student student, MappingContext context) {
